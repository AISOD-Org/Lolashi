...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#FFFBF0]/95 backdrop-blur-sm border-b border-border/50 shadow-sm">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden bg-[#FFFBF0] border-b border-border overflow-hidden"
          >
